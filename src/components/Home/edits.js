    ...
    <div className='skill' id='skills'>
      ...
      <div className='container'>
            ...
            <div className='skill-bx'>
              <Carousel centerMode responsive={responsive} autoPlay autoPlaySpeed={1500} rtl infinite draggable swipeable customRightArrow={<CustomRightArrow/>} customLeftArrow={<CustomLeftArrow/>} className='skill-slider'>
                {
                  slides.map(slides=> 
